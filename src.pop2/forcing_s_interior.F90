...
!
! !REVISION HISTORY:
!  SVN:$Id: forcing_s_interior.F90 68633 2015-03-02 21:22:24Z mlevy@ucar.edu $
!
! !USES:
...
!-----------------------------------------------------------------------
   ...
   integer (int_kind) :: &
      tavg_S_INTERIOR,   &! tavg_id for surface heat flux
      tavg_S_INTERIOR_2   ! tavg_id for surface heat flux
...
!      call accumulate_tavg_field(S_INTERIOR_DATA(:,:,k,bid,now), tavg_S_INTERIOR, bid, k)
